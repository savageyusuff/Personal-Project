...
char ssid[] = "Yusuff Iphone";      //  your network SSID (name) 
char pass[] = "born@1994";   // your network password
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (currentLine.endsWith("GET /F")) {
          ...
          if(inches <4 ){
            ...
            digitalWrite(ENABLE_PWM_2, HIGH);
            delay(2000);
            digitalWrite(DRIVE_1, LOW);//moving front, turning right
            digitalWrite(DRIVE_2, HIGH);
        ...
        if (currentLine.endsWith("GET /B")) {
          ...
          digitalWrite(DRIVE_1, HIGH);//setting the initial value
          digitalWrite(DRIVE_2, LOW);
          digitalWrite(ENABLE_PWM_1, HIGH);    
          digitalWrite(ENABLE_PWM_2, HIGH);
        }
